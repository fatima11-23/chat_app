defmodule ChatAppWeb.ChatLive do
  ...
  def render(assigns) do
          ...
          <.form for={%{}} as={:form} phx-submit="set_name">
           ...
           if @dark_mode, do: "bg-gray-800 text-white placeholder-gray-400", else: "bg-white text-black placeholder-gray-600"}
            ...
            <div class="mb-2 sm:mb-4">
              <p class="mb-1 sm:mb-2 text-xs sm:text-base text-gray-600 dark:text-gray-300 font-semibold">
                Choose your avatar:
              </p>
            ...
            <div class="flex gap-1 flex-wrap mb-1">
              <%= for room <- @rooms do %>
                <button
                  ...
                  phx-value-room={room}
                  id={"room-btn-#{String.replace(room, "#", "")}"}
                  phx-hook="RoomSwitcher"
                  class={"room-button " <>
    ...
    <!-- Desktop: Full screen layout -->
          <div class="hidden sm:flex sm:flex-1 sm:overflow-hidden">
            ...
            <div class="chat-sidebar">
              <div class="mb-4">
              <h2 class="text-lg font-bold flex items-center gap-2 mb-4 text-gray-800 dark:text-white">
                  ...
                  <div class="space-y-2">
                    <%= for room <- @rooms do %>
                      <button
                        phx-click="switch_room"
                        phx-value-room={room}
                        id={"desktop-room-btn-#{String.replace(room, "#", "")}"}
                        phx-hook="RoomSwitcher"
    ...
    <!-- Desktop input area -->
     ...
     class="flex-grow border px-4 py-3 rounded-full text-base
    ...
    />
                    ...
                    <button
                      type="submit"
                      class="bg-blue-600 text-white px-6 py-3 rounded-full hover:bg-blue-700 text-base transition-colors flex-shrink-0"
                    >
                      Send
                    </button>
                  </div>
    ...
    <!-- Mobile chat area -->
     ...
     phx-debounce="300"
      phx-hook="MessageInput"
      class="flex-grow border px-3 py-2 rounded-full text-sm
         bg-white dark:bg-gray-800
         text-gray-900 dark:text-white
         placeholder-gray-500 dark:placeholder-gray-400
         border-gray-300 dark:border-gray-600
    ...
    />
                ...
                <button
                  type="submit"
                  class="bg-blue-600 text-white px-2 py-2 rounded-full hover:bg-blue-700 text-xs transition-colors flex-shrink-0"
                >
                  📤
                </button>
              </div>
  ...
  defp render_message(id, msg, current_user, reactions, show_reaction_picker) do
    ...
    <li
      id={@id}
      class={"mb-3 sm:mb-4 flex message-slide-in " <> if @msg.username == @current_user, do: "justify-end", else: "justify-start"}
    >
              ...
              <div class="file-attachment">
                ...
                <% else %>
                  <a
                    href={file_url}
                    target="_blank"
                    class={"flex items-center gap-2 underline " <> if @msg.username == @current_user, do: "text-blue-200 hover:text-blue-100", else: "text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"}
                  >
  ...
  defp decorate_message(msg, fallback_avatar) do
    ...
    attachment_url =
      case Map.get(msg, :attachment_url) do
        nil -> ""
